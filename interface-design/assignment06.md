...
I tested the accessibility of these color schemes using Figma's Spark plugin's Contrast Checker. The results of those tests for each variation can be found below.
